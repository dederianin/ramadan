...
echo "\n".color("white","Claim?: y/n ");
        ...
        $code1 = request1('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"EKSTRAHEMAT"}');
        $message = fetch_value($code1,'"message":"','"');
        if(strpos($code1, 'Promo kamu sudah bisa dipakai.')){
        echo "\n".color("green","🔓▶️ Message: ".$message);
        goto gofood;
        ...
        $code1 = request2('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"PARSEL"}');
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("green","🔓▶️ Message: ".$message);
